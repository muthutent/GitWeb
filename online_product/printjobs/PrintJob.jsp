...
%>
<%@ page import="java.util.regex.*,java.util.*,com.cdc.spring.model.SearchModel,com.cdc.spring.util.*,datavalidation.*,leadsconfig.*,java.util.Map,java.lang.StringBuffer,java.math.BigDecimal,common.bean.ContentBean,java.net.URLEncoder,java.util.Date,javax.swing.text.DateFormatter,java.text.*,java.rmi.*,common.bean.*,javax.rmi.*,javax.naming.*,javax.ejb.*,content.*"%>
...
<script src="../JSScripts/global.js"  language="javascript"></script>-->
<html>
<head>
<title>CDCNews details job display</title>
<link href="<%=request.getContextPath()%>/css/sheet.css" rel="stylesheet" type="text/css">
...
<div id="message_body">
<FORM ACTION="" NAME="mainform" METHOD="post"><table border="0" cellspacing="0" cellpadding="0" > 
  <TR> 
    <TD> <table border="0" cellpadding="0" cellspacing="0" width="440"> <tr> 
        <td> <table border="0" cellpadding="0" cellspacing="0"  WIDTH="100%">
			...
			<!-- THIS IS FOR JOB TYPE. ADDED BY MUTHU ON 03/18/13-->
			<TR class="row2">
				 <TD colspan="4" bgcolor="#FFFFFF" class="black12px">
											...
											if (ownerKeyWords.equalsIgnoreCase(contactType))
											 {
												 ...
												 if (semicolon_index != -1)
												 {
													 ...
													 company_name = company_name.substring(semicolon_index+1,name_length)
														...
														{
															System.out.println("ERROR: while parsing compay_name for printing on currentContact "+ex.toString());
														}
												 }
													...
													common.bean.ExtractContact contactOthers = (common.bean.ExtractContact)ownersList.get(ownerCounter);
													  ...
													  if (semicolonIndexOthers != -1)
													 {
														 ...
														 companyNameOthers = companyNameOthers.substring(semicolonIndexOthers+1,nameLengthothers)
															...
															{	
																System.out.println("ERROR: while parsing companyNameOthers for printing on contactOthers "+ex.toString());
															}
													 }
