...
<%
	...
	System.out.println("ListSize"+idList);
    ...
    // out.println("idstring"+idString);
	 ...
	 System.out.println("Input String to GetContent List::"+idString);
	 ArrayList contentList=null;
	 System.out.println("Before getContentList");
	 contentList=searchModel.getContentList(idString);
	  System.out.println("After getContentList");
	  
	  if(con==null)	con = DBController.getDBConnection();
	  
	 //out.println("size"+contentList.size());
	 System.out.println("ContentList->"+contentList);
	 if(contentList!=null){System.out.println("NotNUll");}else{System.out.println("ContentList is Null");}
        ...
        <TR> 
          <TD CLASS="black11px" > 
            <%
							  			...
							  			String notes=null;
									   System.out.println("Before Notes"+userBean.getLoginId()+":::"+cbean.getCDCID());
									  	notes=searchDao.getPTNotes(userBean.getLoginId(),cbean.getCDCID(),con);
