...
com.cdc.util.CDCUtil,common.utils.*,com.cdc.controller.DBController,java.io.*,java.util.Date,java.util.regex.*,java.util.*,leadsconfig.*,java.text.*,java.util.Map ,java.lang.StringBuffer,java.net.URLEncoder,java.math.BigDecimal,javax.rmi.*,common.*,common.bean.*,javax.swing.text.DateFormatter,java.text.*,java.sql.*,java.util.Date" %>
...
<%!//getMainSearchResults
  ...
  String bidDateTo,String bidDateFrom,String conTypeList,String bidType,String divisionIdList,String selectedState,String filterColumnFlag,String loginId,String showAllRecordsFlag,String userCountylist,Connection con) 
       {
	System.out.println(stateNameList+':'+countyIdList+':'+sectionAbbList+':'+industryList+':'+subIndustryList+':'+conTypeList+':'+bidType+':'+divisionIdList+':'+userCountylist);
    ...
    try {
     /*  if (con == null) {
      ...
      cstmt = con.prepareCall("{call CA_PROJECTS_LEVEL2(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
	  ...
	  cstmt.setString(11,selectedState);
	  cstmt.setString(12,filterColumnFlag);
	  cstmt.setString(13,loginId);
	  cstmt.setString(14,showAllRecordsFlag);
	  cstmt.setString(15,userCountylist);
	  //System.out.println(selectedState+"selectedState"+bidDateTo+filterColumnFlag);
      ...
      /* while (rs.next()) {
        ...
        //searchResults.add("<img src=\"../../jsp/images/details_open.png\">");
		id=rs.getInt("ID");
      ...
      cstmt.close(); */
    	...
    	String query = "CA_PROJECTS_LEVEL2(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      ...
      /* try {
        ...
        System.out.println("!exception3.2!SQL error in getMainSearchResults" +
                           se);
        ...
        try {
          ...
          System.out.println("!exception3.3!SQL error in getMainSearchResults" +
                             se);
   ...
   String bidDateFrom,String constructType,String bidtype,String divisionName,String selectedState,String filterColumnFlag,String loginId,String showAllRecordsFlag,String userCountylist,Connection con) {
    JSONObject jsonObject = null;
	ArrayList mainList=null;
    try {
      jsonObject = new JSONObject();
	  mainList = new ArrayList();
	  mainList = getMainSearchResults(state_name,county,section_name,industry_type,sub_industry_type,bidDateTo,bidDateFrom,constructType,bidtype,divisionName,selectedState,filterColumnFlag,loginId,showAllRecordsFlag,userCountylist,con);
      ...
      System.out.println(state_name+"SELECTED STATE"+selectedState+"FILTER COLUMN"+filterColumnFlag+"LOGINID"+loginId+"section_name"+ section_name);
...
<%
	...
	if(searchBean.getShowAll())
	 ...
	 {
		showAllRecordsFlag="all";//request.getParameter("showAllFlag");
	...
	// Getting DB Connection
	 ...
	 out.println(getMainSearchResultsList(state_name,county,section_name,industry_type,sub_industry_type,bidDateTo, bidDateFrom,constructType, bidtype, divisionName,selectedState, filterColumnFlag,sessionLoginId,showAllRecordsFlag,userCountylist,con));
	}catch(Exception ex) {
		System.out.println("Exception at inner_projectSearchREsults_CA.jsp ");
		ex.printStackTrace();
	}
	finally{
