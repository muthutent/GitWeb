...
%>
   ...
   <%
	 ...
	 <% if(request.getParameter("include_email") == null || !request.getParameter("include_email").trim().equals("false")) { %>
	 <cdc:email />
	 <% } %>
...
<!-- check to not to perform project hits in Detail Search results and while clicking 'View all in detail' button -->
 <% if(request.getParameter("project_hit") == null || !request.getParameter("project_hit").trim().equals("no")) { %>
